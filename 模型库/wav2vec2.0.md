...
key_concepts: ["[[SpeechTokenizer]]", "[[SemanticvsAcousticTokens]]", "[[Gumbel-Softmax]]", "[[CodebookCollapse]]", "[[Self-SupervisedSpeechRepresentation]]"]
tasks: []
key_papers: ["[[论文笔记/wav2vec2.0|wav2vec 2.0]]", "[[论文笔记/TraceableTTS|Traceable TTS]]"]
