...
<!-- scope: 本页覆盖 TTS 后训练优化(DPO/GRPO/RL/蒸馏)、评估方法(MOS/自动指标/benchmark)、对齐与时长提取、域适配微调、训练数据工程。
...
- [[论文笔记/ProsodyEval|ProsodyEval]] — 2025, DS-WED (semantic token 加权编辑距离韵律多样性指标) + 首个人类标注韵律多样性 benchmark
