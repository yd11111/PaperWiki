...
Naive ASR+LLM+TTS 管线 (2020-) → GSLM (首个 SpeechLM, 2021) → AudioLM/pGSLM (层级建模+副语言, 2022) → TWIST/SPIRIT-LM (TextLM 初始化+跨模态训练, 2024) → SpeechGPT/Moshi/Mini-Omni (全双工 omni-model, 2024) → VITA/MiniCPM-o (IPR+多模态融合, 2024-2025) → [[论文笔记/Ming-Flash-Omni|Ming-Flash-Omni]] (高稀疏 MoE 100B/6.1B + 连续 VAE speech + vision/speech/image 统一感知-生成, 2026)
