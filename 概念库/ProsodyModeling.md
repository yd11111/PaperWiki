...
**NVV 多轴评估**: [[论文笔记/NVV-SuperBench|NVV-SuperBench]] (Xue et al., 2026) 将 NVV 评估从 NV-Bench 的 14 类/PCER 单指标扩展至 45 类/multi-axis protocol (objective + subjective + LLM-judge),4,500 条双语数据,15 个系统。将 speech quality 与 NVV controllability/placement/perceptual salience 解耦评估。关键发现: NVV 可控性与语音质量 decouple (CosyVoice 2 ZH: quality 4.35 但 NVV accuracy 1.65); low-SNR oral cues (tsk, lipsmack) 和 long-duration affect (crying, wail) 是持续瓶颈 [Fig. 2, Table 4]。
