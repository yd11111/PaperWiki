...
- [[论文笔记/Survey-VoiceCloning|Azzuni & El Saddik (2025)]]: 建立四分类体系的综合性 survey
...
- [[SpeakerAdaptation]]: 四分类中的基础类别
- [[SpeakerEmbedding]]: 所有 cloning 方法的核心表示
- [[SpeakerVerification]]: 评估 speaker similarity 的关键工具
- [[SpeechFactorization]]: 贯穿所有 cloning 类别的核心子课题
- [[LLM-basedTTS]]: Zero-shot VC 的主流现代范式
- [[Anti-spoofingandDeepfakeDetection]]: Voice cloning 的伦理对偶
