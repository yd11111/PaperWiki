...
- [[Full-duplex Spoken Dialogue]]: Turn-taking 是全双工对话的核心交互机制
- [[Streaming Spoken Dialogue]]: 流式处理是实时 turn-taking 的架构基础
- [[Spoken Dialogue Evaluation]]: Interaction Capability 评估涵盖 turn-taking 质量
- [[Speech Language Model]]: Turn-taking 是 SpeechLM 的高级交互能力
