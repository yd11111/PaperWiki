...
key_papers: ["[[论文笔记/Survey-Audio Diffusion Models|Survey-Audio Diffusion Models]]", "[[论文笔记/FlowDec|FlowDec]]", "[[论文笔记/VoiceFlow|VoiceFlow]]", "[[论文笔记/StableForm-TTS|StableForm-TTS]]", "[[论文笔记/Bridge-TTS|Bridge-TTS]]", "[[论文笔记/DMOSpeech|DMOSpeech]]", "[[论文笔记/RapFlow-TTS|RapFlow-TTS]]"]
...
- [[Diffusion Model]]: Score matching 是 diffusion 的理论基础之一
- [[Conditional Flow Matching]]: 与 score-based SDE 通过 probability flow ODE 相连
