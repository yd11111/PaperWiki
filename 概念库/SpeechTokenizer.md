...
这些发现有 tokenizer 设计启示: NAC token 的 Zipf/Heaps 统计量可作为 tokenizer 质量的快速 proxy 指标。详见 [[论文笔记/NACTokenLanguageAnalysis|NAC Token Language Analysis]]。
