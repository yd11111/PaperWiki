...
**训练目标** (详见 [[CodecTrainingObjectives]]):
...
- [[SpeechTokenizer]]: 各类 tokenizer 的统称和通用定义
- [[SemanticvsAcousticTokens]]: 传统二分法,本 taxonomy 意在细化和替代
- [[ResidualVectorQuantization]]: Axis 2 中最常见的量化方法
- [[FiniteScalarQuantization]]: Axis 2 中的无码本替代方案
- [[CodecTrainingObjectives]]: Axis 3 中训练目标的详细定义
- [[Single-codebookvsMulti-codebook]]: Axis 2 中 SVQ vs RVQ 的核心 trade-off
