...
| LLM 时代 | [[论文笔记/SCVALL-E|SC VALL-E]] (2023) | GST + scale factors 在 LLM TTS 中 |
...
- 环境自适应 TTS: [[论文笔记/SaSLaW|SaSLaW (Take et al., Interspeech 2024)]] 将 GST 的 reference 从目标风格音频替换为 hearing audio (环境噪声+对话者语音的混合信号),通过 Env-to-style predictor 从听觉感知预测 style vector,实现噪声环境下的语音风格自适应。这是 GST 从"风格迁移"到"环境适应"的功能扩展
...
- [[StyleTransferinTTS]]: GST 是风格迁移的奠基机制
- [[ProsodyModeling]]: GST 的 style 包含韵律信息
- [[SpeakerEmbedding]]: 与 GST 的 style embedding 需解耦
- [[Attention-basedTTS]]: GST 基于 Tacotron 架构
- [[SpeechFactorization]]: GST 后续的解耦改进方向
