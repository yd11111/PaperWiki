...
| LSE-C↑ | **8.083** | 4.001 | 2.507 | 4.016 | 2.013 | LRS2 | [Table 1] |
| LSE-D↓ | **6.586** | 8.192 | 8.155 | 7.914 | 15.891 | LRS2 | [Table 1] |
...
4. **指标绝对值仍然偏低**: 最佳 PESQ 1.61(LRW),远低于 TTS 系统(通常 3.5+),lip-to-speech 任务本身仍有很大提升空间
