...
concepts: ["[[Audio-LanguagePretraining]]", "[[AudioUnderstanding]]", "[[SpeechLanguageModel]]"]
created: 2026-06-02
updated: 2026-06-02
---
...
| 概念 | 核心内容 |
|------|----------|
| [[Audio-LanguagePretraining]] | CLAP 范式、ALM 架构、训练目标、模型族谱、下游任务、LALM |

### 追加更新 (1 个)

| 页面 | 更新内容 |
|------|----------|
| [[AudioUnderstanding]] | 补充 ALM 视角: audio captioning, AQA, ATR; LALM 模型; 扩展 benchmark |
