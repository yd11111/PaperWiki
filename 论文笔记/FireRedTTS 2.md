...
concepts: ["[[Speech Tokenizer]]", "[[Residual Vector Quantization]]", "[[Semantic vs Acoustic Tokens]]", "[[LLM-based TTS]]", "[[Speaker Embedding]]", "[[Neural Vocoder]]"]
models: ["[[Whisper]]"]
tasks: []
...
> [!info] KB 背景 (基于 6 个已确认实体页: [[Speech Tokenizer]], [[Residual Vector Quantization]], [[Semantic vs Acoustic Tokens]], [[LLM-based TTS]], [[Speaker Embedding]], [[Neural Vocoder]])
> 自动生成,不保证完整覆盖所有相关知识。
> 检索命中: [[Speech Tokenizer]]✓, [[Residual Vector Quantization]]✓, [[Semantic vs Acoustic Tokens]]✓, [[LLM-based TTS]]✓, [[Speaker Embedding]]✓, [[Neural Vocoder]]✓ | 过滤: [[Emotion Control in TTS]](待确认), [[Streaming Spoken Dialogue]](待确认) | 未命中但可能相关: Dialogue TTS
...
检索命中: [[Speech Tokenizer]], [[Residual Vector Quantization]], [[Semantic vs Acoustic Tokens]], [[LLM-based TTS]], [[Speaker Embedding]], [[Neural Vocoder]] | 过滤: [[Emotion Control in TTS]](pending-review), [[Streaming Spoken Dialogue]](pending-review) | 未命中但可能相关: Dialogue TTS
