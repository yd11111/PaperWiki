...
> [!info] KB 背景 (基于 4 个已确认实体页 + 2 个待确认实体页: [[模型库/CosyVoice|CosyVoice]], [[Conditional Flow Matching]], [[Speech Tokenizer]], [[Zero-shot Speech Synthesis]], [[Codec Language Model]], [[Speech-Text Alignment]])
> 自动生成,不保证完整覆盖所有相关知识。
>
