...
concepts: ["[[Speech Language Model]]", "[[Speech Tokenizer]]", "[[LLM-based TTS]]", "[[Modality Adaptation for Speech LLM]]", "[[Instruction-Guided Speech Synthesis]]"]
...
> [!info] KB 背景 (基于 3 个已确认实体页: [[Speech Language Model]], [[Speech Tokenizer]], [[LLM-based TTS]])
> 自动生成,不保证完整覆盖所有相关知识。
> 检索命中: [[Speech Language Model]]✓, [[Speech Tokenizer]]✓, [[LLM-based TTS]]✓ | 过滤: [[Modality Adaptation for Speech LLM]](pending-review), [[Instruction-Guided Speech Synthesis]](pending-review), [[Emotion Control in TTS]](pending-review) | 未命中但可能相关: [[Differentiable Reward Optimization]](pending-review)
>
