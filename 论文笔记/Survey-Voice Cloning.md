...
| 概念 | 核心内容 |
|------|----------|
| [[Voice Cloning Taxonomy]] | 四分类体系: adaptation / few-shot / zero-shot / multilingual |
| [[Speaker Verification]] | 双重角色: TTS 评估指标 + 安全/训练组件 |
| [[Anti-spoofing and Deepfake Detection]] | Voice cloning 的伦理维度与检测技术 |
| [[Speaker Adaptation]] | 基于微调的说话人声音复制方法 |

### 更新概念页 (2 个)

| 概念 | 更新内容 |
|------|----------|
| [[Speaker Embedding]] | 补充 voice cloning survey 视角: SECS/SV-EER 评估体系、speaker encoder 在三类 cloning 中的角色差异 |
| [[Speech Factorization]] | 补充 voice cloning survey 中跨三类方法的 disentanglement 技术汇总 |
