...
arxiv_id: "2410.03751"
source: "Sources/Survey-SpeechLanguageModels.pdf"
...
concepts: ["[[SpeechLanguageModel]]", "[[SpeechTokenizer]]", "[[SemanticvsAcousticTokens]]", "[[CodecLanguageModel]]", "[[Full-duplexSpokenDialogue]]", "[[Speech-TextAlignment]]", "[[AudioUnderstanding]]", "[[ProsodyModeling]]"]
models: ["[[HuBERT]]", "[[w2v-BERT]]", "[[wav2vec2.0]]", "[[EnCodec]]", "[[SoundStream]]", "[[Whisper]]", "[[VITS]]", "[[BigVGAN]]"]
tasks: []
datasets: []
...
> [!info] KB 背景 (基于 6 个已确认实体页: [[SpeechLanguageModel]], [[SpeechTokenizer]], [[SemanticvsAcousticTokens]], [[LLM-basedTTS]], [[ResidualVectorQuantization]], [[NeuralVocoder]])
...
>
> 检索命中: [[SpeechLanguageModel]]✓, [[SpeechTokenizer]]✓, [[SemanticvsAcousticTokens]]✓, [[LLM-basedTTS]]✓, [[ResidualVectorQuantization]]✓, [[NeuralVocoder]]✓ | 过滤: 无 | 未命中但可能相关: 无
