...
> - **指标**: MOS 4.14 (本文) vs 4.19 (Apple VoiceOver) vs 4.83 (人类), 无显著差异 (p=0.64) [§4.2]; 句子 5 本文 4.53 显著优于 VoiceOver 3.08 (p<<0.001) [§4.2, Table 1, 3]
...
> | 原则 | 状态 | 备注 |
> |------|------|------|
> | 可复述 | pass | 方法节因果解释清晰,设计选择有WHY,速查可借鉴具体 |
> | 可信赖 | pass | 关键数字出处标注覆盖率>90%,指标名正确 |
> | 可区分 | pass | 来源标注覆盖率高,[论文原文]/[agent解读]区分明确 |
> | 可定位 | pass | KB背景谱系定位具体,创新判断有对比基准 |
> | 不污染 | pass | 不新建概念页,反向更新为追加操作,无factual-error |
> 
> Issues: 3 (high: 0, medium: 1, low: 2)
> 详见 `_review/ShanghainTTS-review.yml`
